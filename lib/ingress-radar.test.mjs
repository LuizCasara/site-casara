...
import {RADAR_AXES, RADAR_DRAW_MAX, computeRadarAxes, compareRadar} from './ingress-radar.mjs'
...
test('compareRadar: aponta o líder de cada eixo e casa os rótulos', () => {
    const mine = {hacks: 200000, glyphHackPoints: 50000} // hacking 100%
    const theirs = {hacks: 0, glyphHackPoints: 0} // hacking 0%
