 ...
 * visualização aberta (`components/livros/acervo/SeloDeStatus.tsx`) tem uma linha
 * inteira, e o balão de hover da sala 3D divide uma faixa estreita com título,
 * autor e estrelas. Daí as duas variantes.
 *
 * As funções recebem os campos soltos, não um objeto: `lib/livros/acervo/books.ts` usa
 ...
 *
 * .mjs pelo mesmo motivo de lib/livros/sala/shelf-years.mjs: `node --test` roda isto sem
 * etapa de build.
 */
import {anoDeLeitura} from '../sala/shelf-years.mjs';
