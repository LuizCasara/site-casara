 ...
 *
 * Fontes dos limiares (Fev Games, medal guide — conferido em 2026-09):
 *   https://fevgames.net/ingress/ingress-guide/concepts/medal/<slug>/
...
export const BADGES = [
    ...
    {key: 'illuminator', name: 'Illuminator', statKey: 'mindUnitsCaptured',
        tiers: {bronze: 5000, silver: 50000, gold: 250000, platinum: 1000000, onyx: 4000000}},
