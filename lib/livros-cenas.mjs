...
/**
 * A cena depois da qual os anos do acervo entram no trilho — a estante do
 * ACERVO (rotulada "Livros"), não a amarela. Os nichos de ano são dela.
 */
 ...
 *
 * `[sala, camping, mesa, estante, 2020-21, 2022, …, PC]` — os anos entram logo
 * depois da cena da estante do acervo, que é o móvel onde eles moram, e o canto
 * de trabalho fecha a volta. Andar para o lado percorre isso inteiro, em loop, em vez de tratar os
