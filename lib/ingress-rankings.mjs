/**
 * Regras de negócio puras do ranking do Ingress — normalização de chave,
 * guarda do codinome do FencherLC (somente-leitura em `casara.ingress_rankings`),
 * e o comparador de desempate do leaderboard.
 */
...
/**
 * `codenameKey` já deve vir normalizado (via `normalizeCodenameKey`);
 * `fencherlcCodename` é normalizado aqui dentro.
 */
export function isFencherLcCodename(codenameKey, fencherlcCodename) {
    return codenameKey === normalizeCodenameKey(fencherlcCodename)
}
