...
test('loadCatalog traz as 26 badges core, cada uma com statKey válido e 5 tiers crescentes', () => {
...
test('slugForStatKey é a inversa de catalogEntry(...).statKey para as 26', () => {
