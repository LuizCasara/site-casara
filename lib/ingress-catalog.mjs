...
/** Só as badges `group: 'core'` (as 26 de estatística), na ordem do arquivo. */
export function coreBadges() {
...
export function slugForStatKey(statKey) {
    const hit = coreBadges().find((b) => b.statKey === statKey)
    return hit ? hit.slug : null
}

/**
 * Caminho público da arte da badge. `tier` = um dos 5 para badge core;
 * `null`/`'single'` para badge de imagem única (evento).
 */
