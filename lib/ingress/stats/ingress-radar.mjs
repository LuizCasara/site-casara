 ...
 * `lib/ingress/stats/ingress-tier-position.mjs` — linear até o Onyx, log₂ depois dele), e a
 ...
 * ranking (`computeAxisScores` em `lib/ingress/stats/ingress-tier-score.mjs`). Os dois usam a
