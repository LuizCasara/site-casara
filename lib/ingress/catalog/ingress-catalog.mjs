 ...
 * `scripts/ingress/ingress-catalog-gen.mjs`). Consumido pela página, pelo CLI e por
 * `lib/ingress/catalog/ingress-badges.mjs` (que passa a derivar as badges daqui).
 */
