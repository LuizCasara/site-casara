...
} from '@/lib/livros/segredos/marcador-pdf';
import {PERGUNTA_FINAL} from '@/lib/livros/segredos/coisas-da-sala.mjs';
...
// do navegador.
import type {PaginaDoCaderno} from '@/app/(livros)/api/caderno/route';
