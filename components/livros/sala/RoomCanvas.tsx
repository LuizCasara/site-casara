...
import Room, {
    ...
    CADERNO_ANCHOR,
} from '@/components/livros/sala/Room';
import Bookshelf from '@/components/livros/sala/Bookshelf';
import DeskBooks from '@/components/livros/sala/DeskBooks';
import TorreQueroLer from '@/components/livros/sala/TorreQueroLer';
...
import IndexPanel from '@/components/livros/sala/IndexPanel';
import CameraRig, {type Viewpoint} from '@/components/livros/sala/CameraRig';
import {useIsMobile} from '@/components/livros/hooks/use-is-mobile';
import {useFecharLivro} from '@/components/livros/hooks/use-fechar-livro';
import {useAlturaRodape, useAlturaDoElemento} from '@/components/livros/hooks/use-altura-rodape';
import {toShelfBooks} from '@/lib/livros/sala/book-dimensions.mjs';
import type {BookStatus} from '@/lib/livros/acervo/books';
import {NICHO_CAPACIDADE_M} from '@/lib/livros/sala/bookshelf-model.mjs';
import {agruparPorAnoDeLeitura, ordemNaEstante} from '@/lib/livros/sala/shelf-years.mjs';
import {sortShelfBooks, filterShelfBooks, vizinhosDe} from '@/lib/livros/sala/livros-shelf.mjs';
import {
    CENAS, subVizinha, paradaVizinha, subParadasDaCena, indiceDoFoco,
} from '@/lib/livros/sala/livros-cenas.mjs';
import BilheteOverlay from '@/components/livros/overlays/BilheteOverlay';
import CarteiraOverlay from '@/components/livros/overlays/CarteiraOverlay';
import FolhaOverlay from '@/components/livros/overlays/FolhaOverlay';
import CadernoOverlay from '@/components/livros/overlays/CadernoOverlay';
import CadernoDoPremio from '@/components/livros/decor/CadernoDoPremio';
import {fichaDoAcervo} from '@/lib/livros/acervo/ficha-do-acervo.mjs';
import {achadosValidos, podeReceberPremio, temPremio} from '@/lib/livros/segredos/coisas-da-sala.mjs';
import {playSound} from '@/lib/global/sound';
import {marcarCoisa, registrarPremio, useProgressoDaSala} from '@/lib/livros/segredos/progresso-da-sala';
import {buildSpineAtlas, type SpineAtlas} from '@/lib/livros/sala/spine-canvas';
import {
