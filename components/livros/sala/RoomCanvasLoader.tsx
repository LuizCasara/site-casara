...
import {useSalaMontada} from '@/components/livros/sala/ContextoDaSala';
import type {RoomCanvasProps, LivrosMode} from '@/components/livros/sala/RoomCanvas';

const RoomCanvas = dynamic(() => import('@/components/livros/sala/RoomCanvas'), {ssr: false});
