...
import {TIERS, TIER_COLOR, tierLabel} from '@/lib/ingress/catalog/ingress-tiers.mjs'
import {formatGap} from '@/lib/ingress/profile/ingress-timeline.mjs'
import {fmtMedalDate, fmtStat} from '@/lib/ingress/ingress-format.mjs'
...
import RecursionMark from '../hero/RecursionMark'
