...
já que ela pede atribuição no lugar onde a obra é exibida. **Mexeu nesta tabela,
mexa lá também.**
...
| `radio.glb` | [Radio](https://poly.pizza/m/ShNRjTDU3i) | O rádio na estante amarela |
...
Os modelos escolhidos a dedo no poly.pizza nem sempre seguem essa regra, e o
preço aparece. O caso extremo já foi corrigido: o walkie-talkie que ficava na
estante amarela tinha **2,4 MB e 111.564 vértices** — sozinho, quase dois terços
do peso desta pasta — e foi trocado pelo `radio.glb` do próprio Furniture Kit,
com 48 KB e 1.200 vértices. Vale conferir o peso de qualquer modelo novo antes
de adotá-lo; um enfeite de 20cm visto a três metros não justifica megabytes.
