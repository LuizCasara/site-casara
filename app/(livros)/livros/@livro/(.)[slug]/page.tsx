...
import BookOverlay from '@/components/livros/overlays/BookOverlay';
import CardDoLivro from '@/components/livros/acervo/CardDoLivro';
import CloseBookButton from '@/components/livros/overlays/CloseBookButton';
