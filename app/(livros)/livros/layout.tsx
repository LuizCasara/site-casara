import {listarLivros, listarTags, type Book} from '@/lib/livros/acervo/books';
import RoomCanvasLoader from '@/components/livros/sala/RoomCanvasLoader';
import ProvedorDaSala from '@/components/livros/sala/ContextoDaSala';
