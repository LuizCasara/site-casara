...
function StarField() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      if (
        Math.random() < 0.004 &&
        shooters.filter((s) => s.op > 0).length < 2
      ) {
        shooters.push({
      ...
      {pts.map((p, i) => (
        <motion.div
          ...
          style={{
            width: p.w,
            height: p.h,
            backgroundColor: `rgba(212,175,55,${p.op})`,
            left: p.left,
            top: p.top,
          }}
      ...
      >
        {HERO_NAME.split("").map((ch, i) => (
          <motion.span
            ...
            animate={
              phase >= 2 ? { opacity: 1, y: 0, filter: "blur(0px)" } : {}
            }
            ...
            style={{
              ...
              textShadow:
                ch === "&" ? "0 0 50px rgba(212,175,55,0.45)" : undefined,
...
function EnvelopeSection() {
  ...
  return (
    ...
    >
      ...
      >
        &ldquo;O amor não é olhar um ao outro,
        <br />
        mas olhar juntos na mesma direção.&rdquo;
        <br />
        <span style={{ color: "#6a6040", fontSize: "0.85rem" }}>
      ...
      >
        <div
          className="relative"
          style={{ width: "min(420px, 90vw)", height: "min(280px, 62vw)" }}
        >
          {/* Corpo do envelope */}
          <div
          ...
          >
            <div
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(to bottom right, #110e06 50%, transparent 50%)",
              }}
            />
            <div
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(to bottom left, #110e06 50%, transparent 50%)",
              }}
            />
            <div
              style={{
                ...
                height: "55%",
                background:
                  "linear-gradient(to top right, #110e06 50%, transparent 50%)",
              }}
            />
            <div
              style={{
                ...
                height: "55%",
                background:
                  "linear-gradient(to top left, #110e06 50%, transparent 50%)",
              }}
            />
          </div>
...
function DetailsSection() {
  ...
  const items = [
    { icon: "📅", label: "Data", value: "Sábado, 17 de Outubro de 2026" },
...
const timelineItems = [
  {
    photos: ["/casamento/2010.jpg", "/casamento/2011.jpg"],
    year: "Começamos namorar",
    title: "2010",
  },
  {
    photos: ["/casamento/2012.jpg"],
    year: "Nos conhecemos melhor",
    title: "2012",
  },
  { photos: ["/casamento/2012-2.jpg"], year: "Noivamos", title: "2012" },
  {
    photos: ["/casamento/2013.jpg"],
    year: "Fomos morar juntos em Cascavel",
    title: "2013",
  },
  { photos: ["/casamento/2015.jpg"], year: "Nos divertimos", title: "2015" },
  {
    photos: ["/casamento/2019.jpg", "/casamento/2019-2.jpg"],
    year: "Viajamos",
    title: "2019",
  },
  {
    photos: ["/casamento/2020.jpg", "/casamento/2020-1.jpg"],
    year: "Adotamos gatos",
    title: "2020",
  },
  {
    photos: ["/casamento/2021-2.jpg", "/casamento/2021-4.jpg"],
    year: "Engravidamos",
    title: "2021",
  },
  {
    photos: [
      "/casamento/2021-1.jpg",
      "/casamento/2021-3.jpg",
      "/casamento/2022-2.jpg",
      "/casamento/2022-1.jpg",
    ],
    year: "Gus nasceu",
    title: "2021",
  },
  ...
  {
    photos: ["/casamento/2023.jpg", "/casamento/2023-1.jpg"],
    year: "Continuamos firmes!",
    title: "2023",
  },
  {
    photos: [
      "/casamento/2024.jpg",
      "/casamento/2024-2.jpg",
      "/casamento/2025-4.jpg",
    ],
    year: "Casamos outros amigos, Brincamos",
    title: "2024",
  },
  {
    photos: ["/casamento/2025-2.jpg", "/casamento/2025-3.jpg"],
    year: "Fortalecemos laços",
    title: "2025",
  },
  {
    photos: [
      "/casamento/2025.jpg",
      "/casamento/2025-6.jpg",
      "/casamento/2025-7.jpg",
    ],
    year: "Fomos batizados",
    title: "2025",
  },
  // {
  //   photos: [
  //     "/casamento/2026.jpg",
  //     "/casamento/greta.jpg",
  //     "/casamento/greta_heart.mp4",
  //   ],
  //   year: "Gus vai ganhar uma irmã!",
  //   title: "2026",
  // },
];
...
function TimelineSection() {
  ...
  return (
    <>
      <AnimatePresence>
        {lightbox && (
          <Lightbox photos={lightbox} onClose={() => setLightbox(null)} />
        )}
      </AnimatePresence>
      ...
      <div ref={ref} className="max-w-lg mx-auto">
        ...
        >
          ...
          <motion.a
            ...
            style={{
              background: `linear-gradient(135deg, ${G} 0%, #9A7B1C 100%)`,
              color: BG,
              textDecoration: "none",
              fontFamily: "var(--font-montserrat)",
              fontSize: "0.73rem",
    ...
    <section className="py-24 px-6 min-h-screen flex flex-col items-center justify-center">
      <div ref={ref} className="max-w-3xl mx-auto w-full text-center">
        ...
        >
          ...
          >
            &ldquo;Amar é encontrar a própria felicidade na felicidade do
            outro.&rdquo;
          </p>
          <p
            style={{
