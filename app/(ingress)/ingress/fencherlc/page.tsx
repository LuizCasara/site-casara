...
import {loadFencherLcRadarOverride} from '@/lib/ingress/profile/ingress-live-override'
import {BADGES, computeAllBadges, computeBadge, nextMedal, TIERS, TIER_LABELS} from '@/lib/ingress/catalog/ingress-badges.mjs'
import {loadCatalog, slugForStatKey} from '@/lib/ingress/catalog/ingress-catalog.mjs'
import {annotateLaneGaps, collectAcquisitions, groupLanes} from '@/lib/ingress/profile/ingress-timeline.mjs'
import {projectNextTier} from '@/lib/ingress/profile/ingress-history.mjs'
import {medalArt} from '@/lib/ingress/catalog/ingress-medal-art.mjs'
import {EmptySignalPanel, PortalsPanel} from '@/components/ingress/profile/IngressPagePanels'
import BackLink from '@/components/ingress/shell/BackLink'
import AgentHeader from '@/components/ingress/profile/AgentHeader'
import StatGroups from '@/components/ingress/profile/StatGroups'
import type {StatBadge} from '@/components/ingress/profile/StatGroups'
import MedalGrid from '@/components/ingress/medals/MedalGrid'
import type {GridMedal} from '@/components/ingress/medals/MedalGrid'
import AchievementTimeline from '@/components/ingress/medals/AchievementTimeline'
import PendingSection from '@/components/ingress/profile/PendingSection'
import ProfileRadar from '@/components/ingress/profile/ProfileRadar'
import ActionsBreakdown from '@/components/ingress/profile/ActionsBreakdown'
import S2Preview from '@/components/ingress/map/S2Preview'
import ApTimeline from '@/components/ingress/profile/ApTimeline'
...
// `/ingress/fencherlc` continua leve, só troca "estático pra sempre" por "estático por
// até 5 min", que é o quanto uma submissão real leva pra valer de qualquer jeito.
export const revalidate = 300

export default async function FencherlcProfilePage() {
