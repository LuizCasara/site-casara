...
const FileSizeConverter = () => {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <h2 className="text-2xl font-bold mb-6">Conversor de Tamanho de Arquivos</h2>
      
      <div className="mb-6">
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          Converta entre diferentes unidades de tamanho de arquivo e estime o tempo de download com base na velocidade da internet.
        </p>
      </div>
            ...
            {result.downloadTime && (
              <div className="mt-3 pt-3 border-t border-green-200 dark:border-green-800">
                ...
                <p className="text-xs mt-1">
                  (com velocidade de {values.internetSpeed} {speedUnits.find(unit => unit.id === values.speedUnit)?.name})
                </p>
              </div>
            )}
          </div>
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
          ...
          <p className="mt-2">
            <strong>Nota:</strong> O tempo de download estimado é teórico e baseado na velocidade máxima informada. Na prática, o tempo real pode variar devido a diversos fatores como latência, congestionamento da rede, limitações do servidor, etc.
          </p>
        </div>
      </div>
    </div>
