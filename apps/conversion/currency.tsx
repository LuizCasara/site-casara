...
const CurrencyConverter = () => {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <h2 className="text-2xl font-bold mb-6">Conversor de Moedas com Histórico</h2>
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
          <p>
            <strong>Nota:</strong> Este conversor utiliza taxas de câmbio simuladas para fins de demonstração.
          </p>
          <p>
            <strong>Taxas de Câmbio:</strong> Em uma aplicação real, as taxas seriam obtidas de APIs como Open Exchange Rates, Fixer.io ou API do Banco Central.
          </p>
          <p>
            <strong>Histórico:</strong> Os dados históricos mostrados são simulados e não representam variações reais do mercado.
          </p>
        </div>
      </div>
    </div>
