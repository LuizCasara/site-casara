        ...
        <div className="p-6 max-w-lg mx-auto">
            ...
            <div className="mt-8 border-t pt-6">
                ...
                <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <p>
                        <strong>Medidas de xícara</strong> podem variar dependendo do país. Este conversor usa o padrão
                        brasileiro.
                    </p>
                    <p>
                        <strong>Dica:</strong> Para maior precisão em receitas, especialmente em confeitaria, é sempre
                        melhor usar medidas de peso (gramas) em vez de volume.
                    </p>
                </div>
            </div>
        </div>
