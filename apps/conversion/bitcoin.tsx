    ...
    <div className="p-6 max-w-lg mx-auto">
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
          <p>
            <strong>Bitcoin (BTC)</strong> é uma criptomoeda descentralizada criada em 2009 por uma pessoa ou grupo de pessoas usando o pseudônimo Satoshi Nakamoto.
          </p>
          <p>
            <strong>Taxas de Câmbio:</strong> Este conversor utiliza taxas de câmbio em tempo real da API CoinGecko para fornecer conversões precisas.
          </p>
          <p>
            <strong>Volatilidade:</strong> O preço do Bitcoin pode ser altamente volátil, com grandes variações em curtos períodos de tempo.
          </p>
          <p>
            <strong>Histórico:</strong> Os dados históricos mostram a variação do preço do Bitcoin nos últimos 7 dias.
          </p>
        </div>
      </div>
    </div>
