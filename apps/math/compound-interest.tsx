    ...
    <div className="p-6 max-w-lg mx-auto">
      <div className="mb-6">
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          Calcule o montante final e os juros ganhos com base no capital inicial, taxa de juros, tempo e frequência de capitalização.
        </p>
      </div>
      ...
      {results && (
        <div className="p-4 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-200 rounded-md mb-6">
          ...
          <div className="space-y-2">
            ...
            <p>
              <span className="font-medium">Capital Inicial:</span> {formatCurrency(parseFloat(values.principal))}
            </p>
            {parseFloat(values.contribution) > 0 && (
              <p>
                <span className="font-medium">Total de Aportes:</span> {formatCurrency(results.totalContributions)}
              </p>
            )}
            <p>
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
          <p>
            <strong>Juros Compostos:</strong> São juros que incidem sobre o capital inicial mais os juros acumulados nos períodos anteriores.
          </p>
          <p>
            <strong>Fórmula:</strong> M = P(1 + i)^n, onde M é o montante final, P é o capital inicial, i é a taxa de juros por período e n é o número de períodos.
          </p>
          <p>
            <strong>Frequência de Capitalização:</strong> Determina quantas vezes os juros são calculados e adicionados ao capital por ano.
          </p>
          <p>
            <strong>Aporte Periódico:</strong> Valor adicional investido regularmente na mesma frequência da capitalização.
          </p>
        </div>
      </div>
    </div>
